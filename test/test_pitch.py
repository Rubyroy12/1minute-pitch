...
class userModelTest(unittest.TestCase):
    def setUp(self):
        self.new_user = User(password= "ibrahim")
...
def test_no_access_password(self):
    ...
    def test_password_verification(self):
        self.assertTrue(self.new_user.verify_password('ibrahim'))


class CommentTest(unittest.TestCase):
    def setUp(self):
        self.user_James = User(username = 'ibra',password = 'doe', email = 'doe@ms.com')
